...
for data in dataset:
    ...
    # plt.show()
    plt.savefig(f'img/spec_8000_10/{file_name}_A.png', bbox_inches="tight", pad_inches=0)
    ...
    plt.savefig(f'img/spec_8000_10/{file_name}.png', bbox_inches="tight", pad_inches=0)
